...
with requests.Session() as s:
    ...
    with open('testfile.txt', 'r') as f:
        Teams = ['Arsenal', 'Aston Villa', 'Barnsley', 'Birmingham', 'Blackburn', 'Blackpool', 'Bolton', 'Bournemouth',
                 'Bradford', 'Brighton', 'Burnley', 'Cardiff', 'Charlton', 'Chelsea', 'Coventry', 'Crystal Palace',
                 'Derby',
                 ...
                 'Sheffield United', 'Sheffield Weds', 'Southampton', 'Stoke', 'Sunderland', 'Swansea', 'Swindon',
                 'Tottenham',
        ...
        for teamName in Teams:
            ...
            teamFiles.write("Premier League Statistics 2016/17\n\n")
