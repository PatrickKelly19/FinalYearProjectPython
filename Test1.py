...
def InsertTeams(word1,word2,word3,word4,word5,word6,word7,word8,word9,word10,word11,word12,word13,word14):
    ...
    cur = conn.cursor()
    cur.execute(
        "insert into PleaseWorkForEverything (HomeTeam, AwayTeam, HomeScore, AwayScore, Winner, Bet365Home, Bet365Draw, Bet365Away, BetAndWinHome, BetAndWinDraw, BetAndWinAway, LadbrokesHome, LadbrokesDraw, LadbrokesAway) values (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
Arsenal = cur.execute("SELECT * FROM PleaseWorkForEverything")
